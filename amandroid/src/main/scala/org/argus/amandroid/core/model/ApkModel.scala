...
case class ApkModel(nameUri: FileResourceUri, layout: DecompileLayout) {
  ...
  private var uirefUriCC: String = ""
  def getUirefUriCC(): String = this.uirefUriCC
  def setUirefUriCC(uirefUri : String) : Unit = this.uirefUriCC = uirefUri

  private var uirefUriCVC: String = ""
  def getUirefUriCVC(): String = this.uirefUriCVC
  def setUirefUriCVC(uirefUri : String) : Unit = this.uirefUriCVC = uirefUri

  private var displayWidget: String = ""
  def getDisplayWidget(): String = this.displayWidget
  def setDisplayWidget(displayWidget : String) : Unit = this.displayWidget = displayWidget

  private var outputPath: String = "."
  def getoutputPath(): String = this.outputPath
  def setoutputPath(outputPath : String) : Unit = this.outputPath = outputPath

  private var sourcePath: String = "."
  def getsourcePath(): String = this.sourcePath
  def setsourcePath(sourcePath : String) : Unit = this.sourcePath = sourcePath
