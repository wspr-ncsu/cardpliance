...
class DefaultInterProceduralDataDependenceInfo(iddg: DataDependenceBaseGraph[InterProceduralDataDependenceAnalysis.Node]) extends InterProceduralDataDependenceInfo{
  ...
  def hasNext(src: InterProceduralDataDependenceAnalysis.Node, iterator: BreadthFirstIterator[InterProceduralDataDependenceAnalysis.Node,InterProceduralDataDependenceAnalysis.Edge]): Boolean={
    iddg.hasNext(src,iterator)
  }
  def next(src: InterProceduralDataDependenceAnalysis.Node,iterator: BreadthFirstIterator[InterProceduralDataDependenceAnalysis.Node,InterProceduralDataDependenceAnalysis.Edge]): InterProceduralDataDependenceAnalysis.Node={
    iddg.next(src,iterator)
  }

  def getIterator(src: InterProceduralDataDependenceAnalysis.Node): BreadthFirstIterator[InterProceduralDataDependenceAnalysis.Node,InterProceduralDataDependenceAnalysis.Edge]={
    iddg.getIterator(src)
  }
}
